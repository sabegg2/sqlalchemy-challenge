...
(1) [climate.ipynb](regrade submission/SurfsUp/climate.ipynb). This contains the Part 1: Analyze and Explore the Climate Data analysis. In this section, I used Python and SQLAlchemy to do a basic climate analysis and data exploration of your climate database. Specifically, I used SQLAlchemy ORM queries, Pandas, and Matplotlib. 

(2) Images folder. This folder contains output images from the Part 1 and Part 2 analyses. 

(3) [app.py](regrade submission/SurfsUp/app.py). This contains the code for Part 2: Design Your Climate App. In this section, I designed a Flask API based on the queries developed in Part 1. When run, the app.py file creates the app at http://127.0.0.1:5000. 

(4) [app.ipynb](regrade submission/SurfsUp/app.ipynb). This contains the same code as app.py, but in Jupyter notebook form. 
...
<img src="regrade submission/SurfsUp/Images/Precipitation_Plot.png" width=800>
<img src="regrade submission/SurfsUp/Images/Precipitation_Plot_2.png" width=500>
...
<img src="regrade submission/SurfsUp/Images/Station_Plot_USC00519281.png" width=500>
...
<img src="regrade submission/SurfsUp/Images/app_output_1.png" width=900>
<img src="regrade submission/SurfsUp/Images/app_output_2.png" width=900>
<img src="regrade submission/SurfsUp/Images/app_output_3.png" width=900>
<img src="regrade submission/SurfsUp/Images/app_output_4.png" width=900>
<img src="regrade submission/SurfsUp/Images/app_output_5.png" width=900>
